...
<body class="animsition">
	...
	<section class="bg0 p-t-23 p-b-140">
		...
		<!-- <div class="whatsapp">
			<a href="https://wa.me/919930475090" class="whatsapp_float" target="_blank"> <i class="fa fa-whatsapp whatsapp-icon"></i></a>
			...
			while($final=$results->fetch_assoc()){ ?>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="images/Product 4.png" alt="IMG-PRODUCT">
	...
	<div class="Whatsapp">
				<a href="https://wa.me/919372232247" class="whatsapp_float" target="_blank"> <i class="fa fa-whatsapp whatsapp-icon"></i></a>
					<style>/* for desktop */
.whatsapp_float {
	position:fixed;
	width:60px;
